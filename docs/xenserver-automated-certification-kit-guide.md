...
The `network.conf` file tells the certification kit which physical interfaces to test and how they are connected. Use the `gen_network_conf.py` script to generate this file interactively.
